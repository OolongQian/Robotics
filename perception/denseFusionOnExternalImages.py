...
parser.add_argument('--mmd_config', type=str, default='mmdetection/configs/ycb_nosyn_mask_rcnn_r101_fpn_1x.py',
                    help='mmdetection config file')
parser.add_argument('--mmd_checkpoint', type=str,
                    default='mmdetection_work_dirs/ycb_nosyn_mask_rcnn_r101_fpn_1x/latest.pth',
...
mmd_results = mmdInferenceOnExternalImages(external_input_images_path, mmd_output_result_path, mmd_config,
                                           mmd_checkpoint)
...
result_pld_dir = os.path.join(df_output_dir, 'masked_plds')
...
if not os.path.exists(result_pld_dir):
    os.makedirs(result_pld_dir)
